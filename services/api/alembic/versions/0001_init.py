...
def upgrade():
    ...
    op.execute("INSERT INTO dim_model (model_id,name,version,quantization,context_length,backend,device) VALUES ('cpu-default','local-llm','0','unknown',4096,'llama.cpp','cpu')")
    op.create_table("dim_session",
    ...
    op.create_table("fact_completion",
    ...
    op.create_table("fact_validation_result",
    ...
    op.create_table("fact_artifact_event",
    ...
    op.create_table("fact_source_change",
